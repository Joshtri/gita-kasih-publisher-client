...
function HomeSection() {
  ...
  return (
    <section
      id="home"
      className="relative py-16 text-white animate__animated animate__fadeIn" // Add animate.css fadeIn effect
      style={{
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto justify-center px-4 sm:px-6 lg:px-8 pb-16 pt-12">
        {/* Introduction */}
        <div className="text-center mb-10 mt-3 animate__animated animate__fadeInDown animate__delay-1s">
        ...
        {/* Call to Action */}
        <div className="flex justify-center mt-8 animate__animated animate__fadeInUp animate__delay-2s">
          <Link
